...
public class TC2E {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement accountant driver.findElement(By.url("https://www.xero.com/us/partner-programs/partners/signup/"));
	    accountant.click();
	    System.out.println("new start page should be displayed Successfully");
